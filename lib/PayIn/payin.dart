    ...
    return Column(
      ...
      children: [
        ...
        Padding(
            ...
            child: Row(
              children: [blueText('Payin', y * 0.033)],
            )),
        Padding(
          padding:
              EdgeInsets.symmetric(vertical: y * 0.002, horizontal: x * 0.013),
        ),
        Padding(
          padding:
              EdgeInsets.symmetric(vertical: y * 0.0108, horizontal: x * 0.020),
          child: SizedBox(
            height: y / 2.5,
            width: x,
            child: Card(
                ...
                children: [
                  ...
                  Align(
                      child: Padding(
                        padding: EdgeInsets.only(
                            left: x * 0.0375, bottom: y * 0.013),
                        child: blueText('Notifications', 18.0),
                      ),
                  ...
                  Align(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'You Recieved Rs. 4000 Salary',
                            style: TextStyle(fontSize: y * 0.019),
                          ),
                        ),
                      ),
                      alignment: Alignment.centerLeft),
